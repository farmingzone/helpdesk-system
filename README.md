...
사내 민원/요청 처리를 통합 관리하는 **면접용 내부 업무 시스템 포트폴리오**입니다.  
...
## 면접 시연 순서
- ADMIN 시연: 등록 -> 상태변경 2회 -> 상세/이력 -> 통계
- REQUESTER 시연: 본인 티켓 조회 가능 + 상태변경 403 확인
